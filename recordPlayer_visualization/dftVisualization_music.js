...
// 2. Use DFT with this epicircle to create a drawing machine
...
function setup() {
    ...
    for (let i = 0; i < loopCount; i++) {
        angle = map(i, 0, loopCount, 0, HALF_PI);
        x[i] = 75 * cos(i / 50);
        // x[i] = i;
        angle = map(i, 0, loopCount, 0, HALF_PI);
        y[i] = 150 * sin(i / 30) - 50;
...
function draw() {
    ...
    //////////////////////////////
    let vx = epiCycles(width / 2 + 200, 100, 0, fourierX); // x value of the vecotr
    ...
    ///////////////////////////////
    // Adjust the speed of drawing
    ///////////////////////////////
    const dt = HALF_PI / fourierY.length;
    time += dt / 2;
